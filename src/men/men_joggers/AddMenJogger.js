...
function AddMenJogger(props) {
  const [name, setMenJoggerName] = useState('');
    ...
    className="block m-2 bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-11 rounded">
      ...
      >
        ...
        <form onSubmit={(e) => {
            ...
            setPrice('')
            setQuantity('')
            props.newMenJogger(name,waist_size,img,color,price,quantity)
        }} 
        id="editmodal" className="w-full max-w-sm m-3">
            <div className="md:flex md:items-center mb-6">
                ...
                placeholder="Jogger"
                value={name}
                onChange={(e) => {setMenJoggerName(e.target.value)}}
                />
                </div>
            </div>
            <div className="md:flex md:items-center mb-6">
